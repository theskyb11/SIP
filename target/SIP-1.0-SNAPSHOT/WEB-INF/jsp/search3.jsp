...
<h1>Search by Certificate ID</h1>
<%--<div class="search-bar">--%>
<%--    <form action="search3" method="post" commandName="userForm" path="email">--%>
...
<form action="search3" method="post" commandName="userForm" path="email">
    ...
    <div class="search-bar">
        <form action="searching" method="post" commandName="userForm" path="email">
            <input type="text" required autocomplete="off" name="search" placeholder="Enter CertificateID">
            <button type="submit" class="searsh-button"></button>
        </form>
    </div>
</form>
