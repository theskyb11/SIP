...
<div class="test">
    ...
    <TABLE cellpadding="15" border="1" style="background-color: #FFFFE0; width: 100%; table-layout: fixed;"
        ...
        <tr style="background-color: #BDB76B;">
            ...
            <th><strong style="font-family: Poppins,sans-serif;">Certificate ID</strong></th>
            ...
            <th><strong style="font-family: Poppins,sans-serif;">Name</strong></th>
            <th><strong style="font-family: Poppins,sans-serif;">Email</strong></th>
            <th><strong style="font-family: Poppins,sans-serif;">Contact Number</strong></th>
