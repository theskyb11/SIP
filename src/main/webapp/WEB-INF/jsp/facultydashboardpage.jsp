...
<h1 style="font-size: 24px; font-weight: bold; color: #707070; margin-bottom: 10px;margin-left: 10px;">
    Name: ${name}</h1>
<h1 style="font-size: 24px; font-weight: bold; color: #707070; margin-bottom: 10px;margin-left: 10px;">
    FacultyID: ${facultyID}</h1>
<br>
<%--<h1> PRN:202101040191</h1>--%>
<div class="button-container">
    <a href="SearchOptions" class="image-button" style="text-decoration: none;">
        <div class="circular-button">
            <img width="240" height="240" src="https://img.icons8.com/color/240/search--v1.png" alt="search--v1"/>
        </div>
        <h3 style="font-size: 30px; font-weight: bold; color: #444442; margin-top: 10px;margin-left: 50px">Search &
            Validate
            Certificate</h3>
    </a>

    <a href="" class="image-button" style="text-decoration: none;">
        <div class="circular-button">
    ...
    <a href="alldisplay" class="image-button" style="text-decoration: none;">
        <div class="circular-button">
            <img src="https://www.linkpicture.com/q/documents.png" alt="Image 3">
        </div>
        <h3 style="font-size: 30px; font-weight: bold; color: #444442; margin-top: 10px;margin-left: 90px">Show All
            Certificates</h3>
    </a>
</div>
